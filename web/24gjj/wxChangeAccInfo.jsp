...
<!--  主体部分  	-->
       <article class="clearfix">
       	    <h3>个人信息变更-- <span>资料修改</span></h3>
       	    <form action="">
				<ul class="formbox clearfix">
					<li>
						<p>公积金账号</p>
						<input type="text" value="<%=request.getAttribute("gjjaccount") %>" id="gjjaccount" >
					</li>
					<li>
						<p>姓名</p>
						<input type="text" value="<%=request.getAttribute("name") %>" id="name" >
					</li>
					
					<li>
						<p>证件类型</p>
						<input type="text" value="<%=request.getAttribute("credit_type") %>" id="credit_type" >
					</li>
					<li>
						<p>证件号码</p>
						<input type="text" value="<%=request.getAttribute("credit_code") %>" id="credit_code" >
					</li>
					<li>
						<p>手机号码</p>
						<input type="text" value="<%=request.getAttribute("mobile") %>" id="mobile" >
					</li>
					<!-- <li>
